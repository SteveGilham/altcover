...
Get-Content "./AltCover.TestData/AltCover.Usage.txt" | % { $_ | Out-File -Encoding UTF8 -Append $mdfile }
...
Get-Content "./AltCover.TestData/AltCover.Runner.Usage.txt" | % { $_  | Out-File -Encoding UTF8 -Append $mdfile }
