...
namespace AltCover.Cake
{
  ...
  public class TestOptions : FSDotNet.ICLIOptions
  {
    ...
    /// <summary>
    /// Gets the undecorated name of the folder to use for instrumented or saved files (instead of $(TargetDir)/__Instrumented or $(TargetDir)/__Saved)
    /// </summary>
    public virtual string OutDirBase => String.Empty;
  }
