...
module ExpectoTestManifest =
  let simpleTests () = [
          ...
          Tests.AltCoverRunnerTests.ParsingJsonGivesJson, "Runner.ParsingJsonGivesJson"
          Tests.AltCoverRunnerTests.ParsingMultipleJsonGivesFailure, "Runner.ParsingMultipleJsonGivesFailure"
          Tests.AltCoverRunnerTests.ParsingNoJsonGivesFailure, "Runner.ParsingNoJsonGivesFailure"
