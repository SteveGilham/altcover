...
module Prepare =
  [<Extension>]
  let WhatIf (prepare : AltCover.FSApi.PrepareParameters) : AltCover.FSApi.ValidatedCommandLine=
...
module Collect =
  [<Extension>]
  let WhatIf (collect : AltCover.FSApi.CollectParameters) afterPreparation : AltCover.FSApi.ValidatedCommandLine=
