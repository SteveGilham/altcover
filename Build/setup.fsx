#r "paket:
nuget Fake.Core.Environment >= 5.9.3
nuget Fake.Core.Process >= 5.9.3
nuget Fake.DotNet.Cli >= 5.9.3
nuget Fake.DotNet.NuGet >= 5.9.3
nuget Fake.IO.FileSystem >= 5.9.3 //"
...
#r "paket:
nuget Fake.Core.Target >= 5.9.3
nuget Fake.Core.Environment >= 5.9.3
nuget Fake.Core.Process >= 5.9.3
nuget Fake.DotNet.AssemblyInfoFile >= 5.9.3
nuget Fake.DotNet.Cli >= 5.9.3
nuget Fake.DotNet.MSBuild >= 5.9.3
nuget Fake.DotNet.NuGet >= 5.9.3
nuget Fake.DotNet.Testing.NUnit >= 5.9.3
nuget Fake.DotNet.Testing.OpenCover >= 5.9.3
nuget Fake.DotNet.Testing.XUnit2 >= 5.9.3
nuget Fake.IO.FileSystem >= 5.9.3
nuget Fake.Testing.ReportGenerator >= 5.9.3
