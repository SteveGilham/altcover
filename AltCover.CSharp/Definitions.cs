...
namespace AltCover.CSharp
{
  ...
  public static class Command
  {
    ...
    public static int Prepare(IPrepareOptions prepareArgs, ILoggingOptions log)
    {
      ...
      return FSharpCommand.Prepare(prepareArgs.ToOptions(), log.ToOptions());
    }
    ...
    public static int Collect(ICollectOptions collectArgs, ILoggingOptions log)
    {
      ...
      if (log == null) throw new ArgumentNullException(nameof(log));
      return FSharpCommand.Collect(collectArgs.ToOptions(), log.ToOptions());
    }
  ...
  public static class DotNet
  {
                                          ...
                                          ICLIOptions options)
    {
      ...
      return FSharpDotnet.ToTestArguments(prepareArgs.ToOptions(),
                                              ...
                                              ICLIOptions options)
    {
      ...
      if (collectArgs == null) throw new ArgumentNullException(nameof(collectArgs));
      if (options == null) throw new ArgumentNullException(nameof(options));
      return FSharpDotnet.ToTestArgumentList(prepareArgs.ToOptions(),
                                             collectArgs.ToOptions(),
                                             options.ToOptions()).
      ToArray();
    }
...
namespace AltCover.CSharp.Primitive
{
  /// <summary>
  ///  This type defines the Collect (runner) behaviour.  The properties map on to the command line arguments for `altcover runner`
  /// </summary>
