...
nuget Fake.DotNet.NuGet >= 5.18.3
...
nuget Fake.DotNet.Cli >= 5.18.3
nuget Fake.DotNet.FxCop >= 5.18.3
nuget Fake.DotNet.ILMerge >= 5.18.3
nuget Fake.DotNet.MSBuild >= 5.18.3
nuget Fake.DotNet.NuGet >= 5.18.3
nuget Fake.DotNet.Testing.NUnit >= 5.18.3
nuget Fake.DotNet.Testing.OpenCover >= 5.18.3
nuget Fake.DotNet.Testing.XUnit2 >= 5.18.3
nuget Fake.IO.FileSystem >= 5.18.3
nuget Fake.DotNet.Testing.Coverlet >= 5.18.3
nuget Fake.Testing.ReportGenerator >= 5.18.3
