#r "paket:
nuget Fake.Core.Environment >= 5.8.5
nuget Fake.Core.Process >= 5.8.5
nuget Fake.DotNet.Cli >= 5.8.5
nuget Fake.DotNet.NuGet >= 5.8.5
nuget Fake.IO.FileSystem >= 5.8.5 //"
...
nuget Fake.Core.Environment >= 5.8.5
nuget Fake.Core.Process >= 5.8.5
nuget Fake.DotNet.AssemblyInfoFile >= 5.8.5
nuget Fake.DotNet.Cli >= 5.8.5
nuget Fake.DotNet.MSBuild >= 5.8.5
nuget Fake.DotNet.NuGet >= 5.8.5
nuget Fake.DotNet.Testing.NUnit >= 5.8.5
nuget Fake.DotNet.Testing.OpenCover >= 5.8.5
nuget Fake.DotNet.Testing.XUnit2 >= 5.8.5
nuget Fake.IO.FileSystem >= 5.8.5
nuget Fake.Testing.ReportGenerator >= 5.8.5
