...
$files = ("_Reports/UnitTestWithAltCoverCoreRunner.xml",
          "_Reports/ApiTestWithAltCoverCoreRunner.net7.0.xml",
          "_Reports/MonitorTestWithAltCoverCoreRunner.net7.0.xml",
          "_Reports/RecorderTestWithAltCoverCoreRunner.net7.0.xml",
          "_Reports/Recorder2TestWithAltCoverCoreRunner.xml",
          "_Reports/ValidateGendarmeEmulationUnitTestWithAltCoverCoreRunner.net7.0.xml",
          "_Reports/Pester.xml" )
