...
module ExpectoMain =
  let regular =
    [| Tests.BaseTests.ExerciseBoth, "BaseTests.ExerciseBoth"
       ...
       Tests.AltCoverRunnerTests.OpenCoverWithPartialsShouldGeneratePlausibleLcov,
       ...
       Tests.AltCoverRunnerTests.JsonWithPartialsShouldGeneratePlausibleXml,
       ...
       Tests.AltCoverRunnerTests.JsonWithPartialsShouldGeneratePlausibleCobertura,
       ...
       Tests.AltCoverTests.NoneOfTheAboveMatchesNoFile,
       "Tests.NoneOfTheAboveMatchesNoFile"
       Tests.AltCoverTests.NoneOfTheAboveMatchesNoPath,
       ...
       Tests.AltCoverTests.TokenGeneratesExpectedULong,
       ...
       Tests.AltCoverTests.ShouldGenerateExpectedXmlReportWithPartialsOpenCoverStyle,
       ...
       Tests.AltCoverTests2.FakedUpKeyIsMatchedInIndex,
       "Tests2.FakedUpKeyIsMatchedInIndex"
       ...
       Tests.AltCoverTests2.ShouldBeAbleToTrackAMethod,
       "Tests2.ShouldBeAbleToTrackAMethod"
  ...
  let consistencyCheck () =
    ExpectoTestCommon.consistencyCheck
      regular
      [ "Tests.AltCoverTests2::ShouldUpdateHandlerOK" ]
