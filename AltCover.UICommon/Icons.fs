...
type Icons<'TIcon>(toIcon: System.IO.Stream -> 'TIcon) =
  ...
  member self.ReportWarning = makeIcon "ReportWarning_16x"
  ...
  member self.MethodDated = makeIcon "MethodDated_16x"
  ...
  member self.SourceDated = makeIcon "TextFileDated_16x"
