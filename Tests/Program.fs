...
module TestMain =
  ...
  let regular = [
          ...
          Tests.AltCoverXTests.TypeSafeCollectParametersCanBeValidatedWithErrors, "XTests.TypeSafeCollectParametersCanBeValidatedWithErrors"
          Tests.AltCoverXTests.CollectParametersCanBePositivelyValidatedWithErrors, "XTests.CollectParametersCanBePositivelyValidatedWithErrors"
          Tests.AltCoverXTests.TypeSafeCollectParametersCanBePositivelyValidatedWithErrors, "XTests.TypeSafeCollectParametersCanBePositivelyValidatedWithErrors"
          Tests.AltCoverXTests.PrepareParametersCanBeValidated, "XTests.PrepareParametersCanBeValidated"
          Tests.AltCoverXTests.TypeSafePrepareParametersCanBeValidated, "XTests.TypeSafePrepareParametersCanBeValidated"
          Tests.AltCoverXTests.TypeSafePrepareParametersCanBeValidatedAgain, "XTests.TypeSafePrepareParametersCanBeValidatedAgain"
          Tests.AltCoverXTests.PrepareParametersStrongNamesCanBeValidated, "XTests.PrepareParametersStrongNamesCanBeValidated"
          Tests.AltCoverXTests.TypeSafePrepareParametersStrongNamesCanBeValidated, "XTests.TypeSafePrepareParametersStrongNamesCanBeValidated"
          Tests.AltCoverXTests.PrepareParametersCanBeValidatedWithNulls, "XTests.PrepareParametersCanBeValidatedWithNulls"
          Tests.AltCoverXTests.PrepareParametersCanBeValidatedAndDetectInconsistency, "XTests.PrepareParametersCanBeValidatedAndDetectInconsistency"
          Tests.AltCoverXTests.TypeSafePrepareStaticCanBeValidated, "XTests.TypeSafePrepareStaticCanBeValidated"
          Tests.AltCoverXTests.TypeSafePrepareParametersCanBeValidatedAndDetectInconsistency, "XTests.TypeSafePrepareParametersCanBeValidatedAndDetectInconsistency"
          Tests.AltCoverXTests.PrepareParametersCanBeValidatedWithErrors, "XTests.PrepareParametersCanBeValidatedWithErrors"
