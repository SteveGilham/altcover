#r "paket:
nuget Fake.Core.Environment >= 5.11.1
nuget Fake.Core.Process >= 5.11.1
nuget Fake.DotNet.Cli >= 5.11.1
nuget Fake.DotNet.NuGet >= 5.11.1
nuget Fake.IO.FileSystem >= 5.11.1 //"
...
#r "paket:
nuget Fake.Core.Target >= 5.11.1
nuget Fake.Core.Environment >= 5.11.1
nuget Fake.Core.Process >= 5.11.1
nuget Fake.DotNet.AssemblyInfoFile >= 5.11.1
nuget Fake.DotNet.Cli >= 5.11.1
nuget Fake.DotNet.FxCop >= 5.11.1
nuget Fake.DotNet.ILMerge >= 5.11.1
nuget Fake.DotNet.MSBuild >= 5.11.1
nuget Fake.DotNet.NuGet >= 5.11.1
nuget Fake.DotNet.Testing.NUnit >= 5.11.1
nuget Fake.DotNet.Testing.OpenCover >= 5.11.1
nuget Fake.DotNet.Testing.XUnit2 >= 5.11.1
nuget Fake.IO.FileSystem >= 5.11.1
nuget Fake.Testing.ReportGenerator >= 5.11.1
