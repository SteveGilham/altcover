...
module Messages =
  ...
  let private showMessageResourceFileWarning
    rn
    (display: Display)
    (file: FileInfo)
    (source: Source)
  ...
  let OutdatedCoverageFileMessage (display: Display) (file: FileInfo) =
    showMessageResourceFileWarning "CoverageOutOfDate" display file (Source.File null)

  let MissingSourceFileMessage (display: Display) (file: FileInfo) =
    showMessageResourceFileWarning "MissingSourceFile" display file (Source.File null)

  let OutdatedCoverageThisFileMessage
    (display: Display)
    (file: FileInfo)
    (source: Source)
    =
