...
_Target "Gendarme" (fun _ -> // Needs debug because release is compiled --standalone which contaminates everything
  ...
  [
   ...
   ("_Binaries/AltCover.Fake/Debug+AnyCPU/netstandard2.0/publish", "netstandard2.0", "./AltCover.Fake/altcover.fake.core.fsproj")
   ...
   ("_Binaries/AltCover.DataCollector/Debug+AnyCPU/netstandard2.0/publish", "netstandard2.0", "./altcover.datacollector/altcover.datacollector.core.csproj")
  ]
