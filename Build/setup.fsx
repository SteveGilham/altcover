#r "paket:
nuget Fake.Core.Environment >= 5.15.0
nuget Fake.Core.Process >= 5.15.0
nuget Fake.DotNet.Cli >= 5.15.0
nuget Fake.DotNet.NuGet >= 5.15.0
nuget Fake.IO.FileSystem >= 5.15.0 //"
...
nuget Fake.Core.Environment >= 5.15.0
nuget Fake.Core.Process >= 5.15.0
nuget Fake.DotNet.AssemblyInfoFile >= 5.15.0
nuget Fake.DotNet.Cli >= 5.15.0
nuget Fake.DotNet.FxCop >= 5.15.0
nuget Fake.DotNet.ILMerge >= 5.15.0
nuget Fake.DotNet.MSBuild >= 5.15.0
nuget Fake.DotNet.NuGet >= 5.15.0
nuget Fake.DotNet.Testing.NUnit >= 5.15.0
nuget Fake.DotNet.Testing.OpenCover >= 5.15.0
nuget Fake.DotNet.Testing.XUnit2 >= 5.15.0
nuget Fake.IO.FileSystem >= 5.15.0
nuget Fake.Testing.ReportGenerator >= 5.15.0
